...
-- INSERT INTO meals (datetime, description, calories, user_id) VALUES ('2015-01-06 09:00', 'breakfast', 500, 100000);
-- INSERT INTO meals (datetime, description, calories, user_id) VALUES ('2015-01-06 13:00', 'dinner', 1000, 100000);
-- INSERT INTO meals (datetime, description, calories, user_id) VALUES ('2015-01-07 00:00', 'supper', 600, 100000);
-- INSERT INTO meals (datetime, description, calories, user_id) VALUES ('2015-01-07 13:00', 'dinner', 1300, 100000);
-- INSERT INTO meals (datetime, description, calories, user_id) VALUES ('2015-01-06 14:00', 'admin_meal', 2000, 100001);
